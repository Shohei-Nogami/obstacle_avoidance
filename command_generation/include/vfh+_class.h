...
class vfh_class{
	private:
		...
		::command_generation::cluster_with_vel cluster;
		cv::Mat depth_image;
		int grid_resolution;//
		float grid_size;
...
//wheel msg
	...
	public:
		...
		void cluster_callback(const command_generation::cluster_with_vel::ConstPtr& msg);
		...
		void set_grid_map(const std::vector<command_generation::point3d>& pt);
