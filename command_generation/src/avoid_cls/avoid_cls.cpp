...
:it_pub(nh_pub_dimg)
{
	...
	pub2 = nh_pub2.advertise<command_generation::select_theta>("select_theta", 1);
...
void avoid::objects_callback(const command_generation::filted_objects_info::ConstPtr& msg)
{
...
void avoid::odometry_callback(const command_generation::robot_odm::ConstPtr& msg)
{
	robot_odm.x=msg->x;
	robot_odm.y=msg->y;
	robot_odm.th=msg->th;
