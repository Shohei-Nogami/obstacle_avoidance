...
*/
void vfh_class::cluster_callback(const command_generation::cluster_with_vel::ConstPtr& msg)
{
...
void vfh_class::set_grid_map(const std::vector<command_generation::point3d>& pt) {
	int grid_x, grid_z;
