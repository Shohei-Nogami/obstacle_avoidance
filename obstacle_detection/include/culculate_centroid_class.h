...
class culculate_centroid{
	private:
		...
		int median_param=3;
	//---cluster
		:: obstacle_detection::cluster pre_cluster;
		:: obstacle_detection::cluster cur_cluster;
	...
	//--time_cls
		...
		public:
			...
			void cluster_callback(const  obstacle_detection::cluster::ConstPtr& msg);
			void subsuctibe_match_index(void);
			void match_index_callback(const  obstacle_detection::matching::ConstPtr& msg);
