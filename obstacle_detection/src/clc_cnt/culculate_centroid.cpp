	...
	:it_pub1(nh_pub1)
{
  ...
  pc_pub = nh_pubpcl.advertise<sensor_msgs::PointCloud2>("clusted_cloud", 1);
	...
	pub2 = nh_pub2.advertise<obstacle_detection::cluster_with_vel>("cluster_with_vel", 1);
	pub3 = nh_pub3.advertise<obstacle_detection::objects_info>("objects_info", 1);
...
void culculate_centroid::cluster_callback(const obstacle_detection::cluster::ConstPtr& msg)
{
...
void culculate_centroid::match_index_callback(const obstacle_detection::matching::ConstPtr& msg)
{
...
{
	obstacle_detection::cluster_with_vel pub_cluster;
...
void culculate_centroid::publish_objects_info(void)
{
	...
	obstacle_detection::objects_info objs;
...
{
  ros::init(argc,argv,"culculate_centroid");
